...
public final class ShaderUtils {
	...
	public static int loadProgram(GL2GL3 gl, String vertexShaderFileName, String fragmentShaderFileName,
			...
			String computeShaderFileName, ObjIntConsumer<GL2GL3> functionBeforeLinking) {
		...
		return loadProgram(gl, shaderFileNames, functionBeforeLinking);
	}
	...
	public static int loadProgram(GL2GL3 gl, String vertexShaderFileName, String fragmentShaderFileName,
		...
		return loadProgram(gl, vertexShaderFileName, fragmentShaderFileName,
				geometryShaderFileName, tessControlShaderFileName, tessEvaluationShaderFileName,
				computeShaderFileName, (glContext, shaderProgram)->{});
	}
	...
	public static int loadProgram(GL2GL3 gl, String shaderFileName) {
		return loadProgram(gl, shaderFileName, (glContext, shaderProgram)->{});
	}
	 ...
	 * @return new id of shader program
	 */
	public static int loadProgram(GL2GL3 gl, String shaderFileName, ObjIntConsumer<GL2GL3> functionBeforeLinking) {
		String[] shaderFileNames = new String[SHADER_FILE_EXTENSIONS.length];
	...
	public static int loadProgram(GL2GL3 gl, String[] shaderFileNames) {
			return loadProgram(gl, shaderFileNames, (glContext, shaderProgram) -> {});
	}
	 ...
	 * @return new id of shader program
	 */
	public static int loadProgram(GL2GL3 gl, String[] shaderFileNames, ObjIntConsumer<GL2GL3> functionBeforeLinking) {
		...
		return loadProgram(gl, shaderSrcArray, functionBeforeLinking);
	}
	...
	public static int loadProgram(GL2GL3 gl, String[] vertexShaderSrc, String[] fragmentShaderSrc,
			...
			String[] computeShaderSrc, ObjIntConsumer<GL2GL3> functionBeforeLinking) {
		String[][] shaderSrcArray = new String[SHADER_FILE_EXTENSIONS.length][];
	...
	public static int loadProgram(GL2GL3 gl, String[] vertexShaderSrc, String[] fragmentShaderSrc,
		...
		return loadProgram(gl, vertexShaderSrc, fragmentShaderSrc,
				geometryShaderSrc, tessControlShaderSrc, tessEvaluationShaderSrc,
				computeShaderSrc, (glContext, shaderProgram)->{});
	}
	...
	public static int loadProgram(GL2GL3 gl, String[][] shaderSrcArray) {
		return loadProgram(gl, shaderSrcArray, (glContext, shaderProgram) -> {});
	}
	 ...
	 * @return new id of shader program
	 */
	public static int loadProgram(GL2GL3 gl, String[][] shaderSrcArray, ObjIntConsumer<GL2GL3> functionBeforeLinking) {
		...
		if (shaders[0] <= 0 && shaders[shaders.length - 1] <= 0){ //no vertex or computer
			System.err.print("No vertex or compute shader available \n");
			return -1;
		}
		
		functionBeforeLinking.accept(gl, shaderProgram);
